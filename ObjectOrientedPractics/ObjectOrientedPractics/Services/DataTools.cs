...
{
    public delegate bool CompareWithValue(Item a, string b);
    ...
    public static class DataTools
    {
        ...
        public static BindingList<Item> SortItems(BindingList<Item> items, string value, CompareWithValue compare)
        {
